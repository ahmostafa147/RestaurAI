...
async def test_main(new_reviews: bool = False, clear_database: bool = False):
    database_path = "tests/data/database.json"
    ...
    try:
        ...
        report = agent.generate_analytics(output_path="analytics_report.json")
        print(f"Analytics report exported to: analytics_report.json")
