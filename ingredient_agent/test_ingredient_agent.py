...
def test_ingredient_agent():
    ...
    restaurant_key = "113b9b80-dda7-41e1-b6d1-f1d7428950c3"  # Chaos Kitchen with absurd inventory
...
def test_with_real_data():
    ...
    report = agent.generate_inventory_report(restaurant_key, "inventory_report.json")
    
    if 'error' not in report:
        print("[OK] Report generated successfully!")
        print(f"Report saved to: inventory_report.json")
