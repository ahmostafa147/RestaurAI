...
async def update_inventory_report(ctx: Context):
    ...
    try:
        ...
        restaurant_key = "d648f285-a940-4101-a013-97d994cdf18e"  # Chaos Kitchen
...
async def handle_metrics(ctx: Context) -> InventoryReportResponse:
    ...
    try:
        ...
        stock = latest_report.get('current_stock', [])
        ...
        metrics = {
            ...
            "timestamp": latest_report.get('metadata', {}).get('generated_at', datetime.now().isoformat())
        }
...
if __name__ == "__main__":
    ...
    print("  GET /metrics - Dashboard metrics (low stock, unavailable items)")
